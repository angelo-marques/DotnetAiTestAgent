...
namespace DotnetAiTestAgent.Application.Messages.Requests;

/// <summary>Mensagem base — todos os requests herdam dela.</summary>
public record AgentRequest : Domain.Messages.Requests.AgentRequest
{
...
public record GenerateReportsRequest   (Pipeline.AgentContext Context) : AgentRequest;
