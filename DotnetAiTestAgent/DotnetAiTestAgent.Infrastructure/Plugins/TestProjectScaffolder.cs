...
public class TestProjectScaffolder
{
    ...
    private async Task WriteCsprojAsync(string csprojPath, SourceProjectInfo sourceInfo)
    {
        ...
        csproj.AppendLine("    <CoverletOutputFormat>opencover</CoverletOutputFormat>");
        ...
        csproj.AppendLine("    <IncludeSource>true</IncludeSource>");
        csproj.AppendLine("  </PropertyGroup>");
        csproj.AppendLine();
        ...
        csproj.AppendLine("    <PackageReference Include=\"Microsoft.CodeAnalysis.CSharp\" Version=\"4.0.0\" />");
        csproj.AppendLine("    <PackageReference Include=\"Bogus\" Version=\"35.6.5\" />");
